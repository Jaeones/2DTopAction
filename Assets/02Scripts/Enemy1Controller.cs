...
public class Enemy1Controller : MonoBehaviour
{
    ...
    public string idleAni = "Enemy1Down";
    public string downAni = "Enemy1Down";
    public string upAni = "Enemy1Up";
    public string leftAni = "Enemy1Left";
    public string rightAni = "Enemy1Right";
    public string DeadAni = "Enemy1Dead";
